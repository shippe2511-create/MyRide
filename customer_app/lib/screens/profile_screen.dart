        ...
        builder: (context, appState, _) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Alert Preferences', style: TextStyle(color: context.mutedColor, fontSize: 13, fontWeight: FontWeight.w500)),
              const SizedBox(height: 12),
              _buildSwitchItem('Sounds', appState.soundsEnabled, (v) => appState.toggleSounds(v)),
              _buildSwitchItem('Vibration', appState.vibrationEnabled, (v) => appState.toggleVibration(v)),
              SizedBox(height: MediaQuery.of(context).padding.bottom),
            ],
          ),
        ),
