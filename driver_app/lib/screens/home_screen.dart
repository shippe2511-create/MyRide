...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildWaitingView(BuildContext context, DriverState state) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(40),
        child: Column(
  ...
  void _showEndBreakConfirmation(BuildContext context, DriverState state) {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(_getBreakIcon(state.breakType), color: AppColors.warning, size: 36),
            ),
            const SizedBox(height: 16),
            Text(
              'End ${state.breakType} Break?',
              style: TextStyle(
                color: context.textColor,
                fontSize: 20,
                fontWeight: FontWeight.w700,
            ...
            Text(
              'You will start receiving ride requests again',
  ...
  Widget _buildQuickActionsRow(BuildContext context, DriverState state) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: context.cardColor,
            ...
            children: [
              _buildActionButton(
                ...
                onTap: () async {
                  ...
                  final ride = state.currentRide;
                  if (ride != null) {
                    final lat = ride.status == RideStatus.inProgress ? ride.dropoffLat : ride.pickupLat;
                    final lng = ride.status == RideStatus.inProgress ? ride.dropoffLng : ride.pickupLng;
